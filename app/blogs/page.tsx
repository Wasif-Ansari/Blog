...
export default function Blogs() { 
  ...
  return (
    <div className="min-h-screen text-white px-4 flex flex-col items-center justify-center bg-gray-900 text-center">
      <section className="py-12 md:py-24 w-2/3">
              ...
              <Link href={`/blogs/${post.id}`} className="bg-gray-800 border border-gray-700 rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300 cursor-pointer hover:scale-105 transform-gpu block">
               <div className="flex flex-col items-center justify-center">
                ...
                <div className="text-center justify-center">
                  <h2 className="text-2xl font-semibold mb-2 text-center">{post.title}</h2>
                  <p className="w-full text-gray-300 text-justify">{post.content}</p>
                </div>
               </div>  
              </Link>
